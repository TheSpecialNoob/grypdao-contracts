...
contract GRYPPower {
    ...
    constructor(
        ...
        _wrappedStakedToken = wrappedStakedToken_;
    }
    ...
    function totalSupply() public view returns (uint256) {
        ...
        uint256 calculatedTotalSupply = tokenTotalSupply.add(stakedTokenTotalSupply).add(
            convertedWrappedStakedTokenTotalSupply
        );
